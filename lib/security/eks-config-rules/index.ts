...
export class EksConfigRulesSetup extends Stack {
    constructor(scope: Construct, id: string, props?: StackProps ) {
      ...
      // Getting the default kubernetes version used by the CDK EKS Blueprints framework.
      const defaultKubVerison = exampleClusterProvider.defaultOptions.version.version;
